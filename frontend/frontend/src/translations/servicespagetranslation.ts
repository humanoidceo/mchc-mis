...
export const servicesPageTranslation: Localized<ServicesPageTranslation> = {
  en: {
    ...
    groups: [
      ...
      { title: 'OPD', items: ['General consultation', 'Laboratory services', 'Ultrasound services', 'Injections and dressing', 'Health counseling'] },
  ...
  fa: {
    ...
    groups: [
      ...
      { title: 'OPD', items: ['معاینات عمومی', 'خدمات لابراتواری', 'خدمات التراسوند', 'تزریقات و پانسمان', 'مشاوره‌های صحی'] },
  ...
  ps: {
    ...
    groups: [
      ...
      { title: 'OPD', items: ['عمومي معاینات', 'لابراتواري خدمات', 'الټراساونډ خدمات', 'پیچکاري او پانسمان', 'روغتیايي مشورې'] },
